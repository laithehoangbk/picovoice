        ...
        try:
            ...
            while True:
                ...
                if num_keywords == 1 and result:
                    time_num = time_num + 1
                    print('[%s] detected keyword %s'% (str(datetime.now()), str(time_num)))
...
def _default_library_path():
    ...
    return os.path.join(os.path.dirname(__file__), '../../lib/linux/i386/libpv_porcupine.so')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensitivity', help='detection sensitivity [0, 1]', default=0.1)
